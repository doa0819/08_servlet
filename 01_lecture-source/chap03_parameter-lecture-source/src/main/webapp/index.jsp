...
<body>
    ...
    <hr>
    <h4>a 태그의 herf 속성에 직접 파라미터를 쿼리스트링 형태로 작성하여 get 요청</h4>
    <a href="querystring?name=이도아&age=20&birthday=2024-04-01&gender=F&national=ko&hobbies=on&hobbies=on&hobbies=on">
        쿼리스트링을 이용한 값 전달
    </a>
    <hr>
